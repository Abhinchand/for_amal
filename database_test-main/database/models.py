...
class PesticidalProteinHiddenSequence(models.Model):
    ...
    # taxonid = models.CharField(max_length=50, validators=[RegexValidator(
    #     r'\d{2,50}', 'Number must digits', 'Invalid number')], blank=True, null=True)
...
class PesticidalProteinPrivateDatabase(models.Model):
    ...
    taxonid = models.IntegerField(blank=True, null=True)
    ...
    othernames = models.TextField(
        blank=True, null=True)
    fastasequence_file = models.FileField(
        upload_to="fastasequence_files/", blank=True, null=True)
...
class ProteinDetail(models.Model):
    ...
    """
    # accession_name = models.ForeignKey(
    #     PesticidalProteinDatabase, on_delete=models.CASCADE, blank=True, null=True)
    ...
    fulllength = models.TextField(
        blank=True, null=True, verbose_name='Length of the protein sequence')
    ...
    domain_N = models.TextField(
        blank=True, null=True, verbose_name='N-terminal domain name')
    pfam_N = models.CharField(
        max_length=25, blank=True, null=True, verbose_name='PFAM ID (Pfam N)')
    cdd_N = models.CharField(max_length=25, blank=True, null=True,
                             verbose_name='Conserved Domain Database ID (CDD N)')
    start_N = models.CharField(
        max_length=10, blank=True, null=True, verbose_name='Amino acid start position')
    end_N = models.CharField(max_length=10, blank=True,
                             null=True, verbose_name='Amino acid end position')
    ...
    domain_M = models.TextField(
        blank=True, null=True, verbose_name='Middle domain name')
    pfam_M = models.CharField(max_length=25, blank=True, null=True,
                              verbose_name='PFAM M')
    cdd_M = models.CharField(max_length=25, blank=True, null=True,
                             verbose_name='CDD M')
    start_M = models.CharField(
        max_length=10, blank=True, null=True, verbose_name='Amino acid start position')
    end_M = models.CharField(max_length=10, blank=True,
                             null=True, verbose_name='Amino acid end position')
    ...
    domain_C = models.TextField(
        blank=True, null=True, verbose_name='C-terminal domain name')
    pfam_C = models.CharField(max_length=25, blank=True, null=True,
                              verbose_name='PFAM C')
    cdd_C = models.CharField(max_length=10, blank=True, null=True,
                             verbose_name='CDD C')
    start_C = models.CharField(
        max_length=10, blank=True, null=True, verbose_name='Amino acid start position')
    end_C = models.CharField(max_length=10, blank=True,
                             null=True, verbose_name='Amino acid end position')
    ...
    def save(self, *args, **kwargs):
        ...
        if self.accession:
            self.name = p.name
        self.name = p.name
        super(ProteinDetail, self).save(*args, **kwargs)
